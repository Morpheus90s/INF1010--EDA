// Pedro Augusto Beserra da Silva - 2321374
#include <stdio.h>
#include <stdlib.h> 
#include <string.h> 
...
BitVector* create_set(int num_bits) {
    ...
    // usei calloc pq ele já zera o vetor.
...
BitVector* set_remove(BitVector* s, int i) {
    ...
    // Criando a mascara pro bit e inverte
